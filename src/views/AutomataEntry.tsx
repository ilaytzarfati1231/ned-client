...
export const AutomataEntry: React.FC<AutomataEntryProps> = ({
  ...
  const [infInfValue, setInfInfValue] = useState<{ [key: string]: string } | null>(null);
  const [omega_value, setOmegaValue] = useState<{ [key: string]: string } | null>(null);
  const [sumInfInfValue, setSumInfInfValue] = useState<{ [key: string]: string } | null>(null);
  const [sumInfInfWords, setSumInfInfWords] = useState<{ [key: string]: string[] }| null>(null);
  const [InfInfWords, setInfInfWords] = useState<{ [key: string]: string[] } | null>(null);
  const [omegaWords, setOmegaWords] = useState<{ [key: string]: string[] }| null>(null);
